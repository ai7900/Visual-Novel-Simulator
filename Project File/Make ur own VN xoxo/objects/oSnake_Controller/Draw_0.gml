...
var _len = snake_arena_size * snake_grid_size;
var _originx = 10 * snake_grid_size;
var _originy = 20 * snake_grid_size
draw_rectangle(_originx,_originy,_originx+_len,_originy,false);/*
